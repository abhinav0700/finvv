...
const AuthLayout = () => {
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      {/* Brand/Image Side */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary/90 to-secondary/90 p-8 text-black items-center justify-center">
        <div className="max-w-md">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">FriendlyFinance</h1>
            <div className="h-1 w-20 bg-black/50 rounded"></div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="mr-3 p-2 bg-black/20 rounded-full">
        ...
        <Card className="w-full max-w-md border border-primary/20">
          <div className="p-8">
            <div className="mb-6 md:hidden">
              ...
              <p className="text-sm text-foreground/70 mt-1">Your personal finance companion</p>
            </div>
