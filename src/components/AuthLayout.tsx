...
const AuthLayout = () => {
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      {/* Brand/Image Side */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary/90 to-secondary/90 p-8 text-white items-center justify-center">
        ...
        <Card className="w-full max-w-md">
          <div className="p-8">
            <div className="mb-6 md:hidden">
              ...
              <p className="text-sm text-gray-600 mt-1">Your personal finance companion</p>
            </div>
